...
public class DoctorAppointments extends EasyApp {

    String doc;

    public DoctorAppointments(String d) {
        doc = d;
        setTitle("H&V clinic management system | " + doc + " Appointments");
        ...
        appointmentsD.setFont(new Font("TimesRoman", 0, 20));
